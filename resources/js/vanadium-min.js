...
Validation.prototype = {
    ...
    validate: function (b, d) {
        var a = {
            success: false,
            message: "Retorna un valor invalido."
        };
        var c = this.test(b, d);
        if (typeof c === "boolean") {
            return {
...
Vanadium.setupValidatorTypes = function () {
    ...
    Vanadium.addValidatorTypes([
        ["equal", function (a, b) {
            ...
            return 'El valor debe ser igual a <span class="' + Vanadium.config.message_value_class + '">' + b + "</span>."
        }],
        ...
        }, "Solo use numeros. Evite espacios u otros caracteres como puntos y comas."],
        ["alpha", function (a) {
        ...
        }, "Use solamente caracteres ASCII (a-z)."],
        ["alphanum", function (a) {
            return Vanadium.validators_types.empty.test(a) || !/\W/.test(a)
        }, "Use solamente letras (a-z) o numeros (0-9). No espacios u otros caracteres."],
        ["date", function (a) {
            var b = new Date(a);
        ...
        }, "Ingrese un monto valido. Por ejemplo $100.00 ."],
        ...
        ["length", function (a, b) {
            ...
            return 'El valor debe ser de <span class="' + Vanadium.config.message_value_class + '">' + b + "</span> caracteres."
        }],
        ["min_length", function (a, b) {
            ...
            return 'El valor debe ser de al menos <span class="' + Vanadium.config.message_value_class + '">' + b + "</span> caracteres."
        }],
        ["max_length", function (a, b) {
            ...
            return 'El valor debe menor que  <span class="' + Vanadium.config.message_value_class + '">' + b + "</span> caracteres."
        }],
        ["same_as", function (b, c) {
            ...
            var a = document.getElementById(c);
            if (a) {
                return 'El valor debe ser igual a <span class="' + Vanadium.config.message_value_class + '">' + (jQuery(a).attr("name") || a.id) + "</span> ."
            } else {
                return "No hay un ejemplar!!!"
            }
        }, "", function (b) {
        ...
        ["format", function (b, e) {
            ...
            var c = b.split("/");
            if (c.length == 3 && c[0] == "") {
                return 'El valor debe poseer el siguiente patron: <span class="' + Vanadium.config.message_value_class + '">' + b.toString() + "</span>."
            } else {
                return 'El parametro previsto <span class="' + Vanadium.config.message_value_class + '">' + b.toString() + "</span> no es un valor de patron valido Regexp."
            }
        }]
    ]);

...
function (f, j) {
    ...
    f.fn.extend({
        ...
        _show: f.fn.show,
        show: function (c) {
            if (!c || typeof c == "number" || f.fx.speeds[c] || !f.effects[c]) return this._show.apply(this, arguments);
            else {
                var a = k.apply(this, arguments);
                a[1].mode = "show";
        ...
        toggle: function (c) {
            if (!c || typeof c == "number" || f.fx.speeds[c] || !f.effects[c] || typeof c == "boolean" || f.isFunction(c)) return this.__toggle.apply(this, arguments);
            else {
                var a = k.apply(this, arguments);
                a[1].mode = "toggle";
                return this.effect.apply(this, a)
...
(function (d, p) {
    ...
    d.widget("ui.tabs", {
        ...
        _setOption: function (a, e) {
            if (a == "selected") this.options.collapsible && e == this.options.selected || this.select(e);
            else {
                this.options[a] = e;
                this._tabify()
            }
...
function compare_dates(pFechaI, pFechaF) {
    var xMonth = pFechaI.substring(3, 5);
    var xDay = pFechaI.substring(0, 2);
    var xYear = pFechaI.substring(6, 10);
    var yMonth = pFechaF.substring(3, 5);
    var yDay = pFechaF.substring(0, 2);
    var yYear = pFechaF.substring(6, 10);

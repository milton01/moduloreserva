...
jQuery.highlightFade.checkColorName = function(c) {
	...
	switch(c.replace(/^\s*|\s*$/g,'').toLowerCase()) {
		...
		case 'select01': return [155,163,255];
		case 'select02': return [0,162,232];
		case 'select03': return [210,210,210];
		case 'yellow01': return [255,255,127];
		case 'red01': return [255,127,127];
	}
};
